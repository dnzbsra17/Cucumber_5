...
public class _10_ApachePOISteps {
    ...
    public void userCreateCitizenshipWithApacehPOI() {
        ArrayList< ArrayList<String> > tablo=
                ExcelUtility.getData("src/test/java/ApachePOI/resorce/ApacheExcel2.xlsx","testCitizen",2);
    ...
    public void userDeleteCitizenshipWithApacehPOI() {
        ArrayList< ArrayList<String> > tablo=
                ExcelUtility.getData("src/test/java/ApachePOI/resorce/ApacheExcel2.xlsx","testCitizen",1);
